...
description: Diagnose scheduling drift, duplicate runs, and execution reliability in cron services.
---


**Cron Operations**

This skill provides operational guidance for `cron-operations`.

**Overview**

- Purpose: Ensure scheduled workflows run at expected cadence without duplication.
- Focus: schedule semantics, run windows, and deterministic timing behavior.

**When to Use This Skill**

- Jobs run at wrong times.
- Duplicate or missed runs are observed.
- Timing behavior regressed after scheduler edits.
