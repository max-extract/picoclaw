---
name: web-tooling
description: Validate web tool request/response behavior and safe result handling.
---


**Web Tooling**

This skill provides operational guidance for `web-tooling`.

**Overview**

- Purpose: Maintain predictable web-tool request/response handling in agent flows.
- Focus: parser robustness, output limits, and failure transparency.

**When to Use This Skill**

- Web tool requests fail or return malformed output.
- Response truncation/parsing behaves incorrectly.
- Tool/web integration regressed after provider updates.
