...
description: Manage skill discovery, validation, search cache, and installation registry behavior.
---


**Skills Registry**

This skill provides operational guidance for `skills-registry`.

**Overview**

- Purpose: Ensure local/remote skill discovery and installation behavior remains correct.
- Focus: metadata validation, source precedence, and registry cache behavior.

**When to Use This Skill**

- Skills are not discovered or load wrong versions.
- Metadata parsing fails unexpectedly.
- Registry search/install behavior regresses.
