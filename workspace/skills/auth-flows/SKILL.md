---
name: auth-flows
description: Maintain OAuth, PKCE, and token storage behavior for PicoClaw authentication.
---


**Auth Flows**

This skill provides operational guidance for `auth-flows`.

**Overview**

- Purpose: Maintain authentication reliability across OAuth, PKCE, and token storage flows.
- Focus: callback integrity, expiry/refresh semantics, and credential safety.

**When to Use This Skill**

- Login flow fails unexpectedly.
- Token refresh/expiry behavior regresses.
- PKCE validation mismatch appears.
