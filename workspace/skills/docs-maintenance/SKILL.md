...
description: Keep documentation accurate, executable, and aligned with current PicoClaw behavior.
---


**Docs Maintenance**

This skill provides operational guidance for `docs-maintenance`.

**Overview**

- Purpose: Keep operational docs aligned with actual commands and runtime behavior.
- Focus: executable examples, drift correction, and clear constraints.

**When to Use This Skill**

- Docs commands fail when executed.
- Feature docs drift after code changes.
- Operator guidance is ambiguous or outdated.
