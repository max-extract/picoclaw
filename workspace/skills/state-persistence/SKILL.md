...
description: Protect runtime state serialization compatibility and persistence correctness.
---


**State Persistence**

This skill provides operational guidance for `state-persistence`.

**Overview**

- Purpose: Protect state schema compatibility and persistence integrity over time.
- Focus: serialization stability, migration-safe reads, and backward compatibility.

**When to Use This Skill**

- Persisted state cannot be read after changes.
- Fields are dropped or malformed after save/load.
- Runtime behavior diverges due to state schema drift.
