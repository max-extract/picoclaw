...
description: Validate migration paths and preserve data integrity across workspace/config upgrades.
---


**Migration Safety**

This skill provides operational guidance for `migration-safety`.

**Overview**

- Purpose: Execute migrations with idempotency and low risk of data loss.
- Focus: conversion correctness, rollback awareness, and legacy compatibility.

**When to Use This Skill**

- Upgrade path fails or produces partial output.
- Legacy config/workspace formats are no longer accepted.
- Migration behavior is non-idempotent.
