...
description: Run structured incident triage, containment, and recovery for PicoClaw outages.
---


**Incident Response**

This skill provides operational guidance for `incident-response`.

**Overview**

- Purpose: Triage incidents quickly and communicate actionable containment steps.
- Focus: impact scope, timeline, subsystem isolation, and recovery direction.

**When to Use This Skill**

- User reports production-impacting outage.
- Core workflows fail repeatedly.
- Multiple subsystems appear degraded.
