...
description: Keep heartbeat signals accurate and actionable with minimal false positives.
---


**Heartbeat Monitoring**

This skill provides operational guidance for `heartbeat-monitoring`.

**Overview**

- Purpose: Keep heartbeat/liveness signals accurate and actionable.
- Focus: threshold behavior, freshness checks, and false-positive control.

**When to Use This Skill**

- Heartbeat reports stale/false statuses.
- Liveness transitions are delayed.
- Threshold changes introduced noisy alerts.
