...
description: Validate session creation, reuse, keying, and cleanup behavior under concurrency.
---


**Session Lifecycle**

This skill provides operational guidance for `session-lifecycle`.

**Overview**

- Purpose: Keep session creation/reuse/teardown deterministic under concurrency.
- Focus: key derivation consistency, lifecycle transitions, and race-safe behavior.

**When to Use This Skill**

- Sessions leak or are not reused correctly.
- Session key collisions or wrong bindings appear.
- Cleanup behavior regresses under load.
