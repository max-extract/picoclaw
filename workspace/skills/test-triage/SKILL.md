---
name: test-triage
description: Isolate, reproduce, and resolve failing tests with minimal turnaround time.
---


**Test Triage**

This skill provides operational guidance for `test-triage`.

**Overview**

- Purpose: Isolate failing tests and restore confidence with minimal turnaround.
- Focus: deterministic repro, root-cause patching, and validation scope.

**When to Use This Skill**

- CI is failing and cause is unclear.
- New edits introduced test regressions.
- Flaky behavior needs isolation.
