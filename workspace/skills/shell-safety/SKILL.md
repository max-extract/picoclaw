---
name: shell-safety
description: Harden shell command execution, timeout handling, and process cleanup paths.
---


**Shell Safety**

This skill provides operational guidance for `shell-safety`.

**Overview**

- Purpose: Prevent shell tool hangs and enforce clean process lifecycle behavior.
- Focus: timeout handling, process cleanup, and platform-specific execution safety.

**When to Use This Skill**

- Commands hang or timeout incorrectly.
- Child processes are not cleaned up.
- Platform-specific shell behavior diverges.
