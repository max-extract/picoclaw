...
description: Debug provider selection, fallback, cooldown, and tool-call parsing behavior.
---


**Provider Debugging**

This skill provides operational guidance for `provider-debugging`.

**Overview**

- Purpose: Diagnose provider selection/fallback/cooldown parsing failures.
- Focus: adapter behavior, fallback chain correctness, and error classification.

**When to Use This Skill**

- Requests fail for one provider but not others.
- Fallback behavior loops or picks wrong provider.
- Tool-call extraction/classification regresses.
