...
description: Troubleshoot device source ingestion, event propagation, and hardware fallbacks.
---


**Device Ingestion**

This skill provides operational guidance for `device-ingestion`.

**Overview**

- Purpose: Stabilize device-source ingestion and event propagation across environments.
- Focus: source selection, platform differences, and ingestion reliability.

**When to Use This Skill**

- Device events are missing or delayed.
- Linux source behavior differs from stubs.
- Hardware-dependent code breaks non-hardware environments.
