...
description: Keep workspace skills, memory files, and local context assets clean and valid.
---


**Workspace Hygiene**

This skill provides operational guidance for `workspace-hygiene`.

**Overview**

- Purpose: Keep workspace-local skill and memory assets coherent and loadable.
- Focus: metadata validity, stale reference cleanup, and local-doc consistency.

**When to Use This Skill**

- Local skills fail to load.
- Workspace context files are stale or conflicting.
- Local operational notes drift from current setup.
